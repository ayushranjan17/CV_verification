# Hackathon_project
1) We imported the data from the hackathon into the jupyter notebook.
...
8) “XGBoost” comes out as the best model and then we predicted values on test data and also done the hyperparameter tuning on “XGBoost”.
